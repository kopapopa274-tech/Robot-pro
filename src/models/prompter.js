...
export class Prompter {
    ...
    async promptConvo(messages) {
        ...
        console.error(`${this.agent.name} failed to generate a response after 3 attempts.`);
        this.agent.openChat("I'm having trouble thinking right now, give me a moment.");
        return '';
    }
